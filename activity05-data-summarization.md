...
**Response**: I think there will be a large spread and right skewed.
...
college_recent_grads %>%
  ...
  summarise(mean_med_earnings = mean(median),
            ...
            max_med_earnings = max(median))%>% 
  ungroup() %>% 
  arrange(min_med_earnings) %>% 
  knitr::kable()
```

| major\_category                     | mean\_med\_earnings | sd\_med\_earnings | min\_med\_earnings | max\_med\_earnings |
|:------------------------------------|--------------------:|------------------:|-------------------:|-------------------:|
| Education                           |            32350.00 |          3892.728 |              22000 |              41000 |
| Psychology & Social Work            |            30100.00 |          5381.914 |              23400 |              40000 |
| Biology & Life Science              |            36421.43 |          4528.912 |              26000 |              45000 |
| Arts                                |            33062.50 |          7223.165 |              27000 |              50000 |
| Humanities & Liberal Arts           |            31913.33 |          3393.032 |              27000 |              40000 |
| Health                              |            36825.00 |          5776.461 |              28000 |              48000 |
| Agriculture & Natural Resources     |            36900.00 |          6935.416 |              29000 |              53000 |
| Industrial Arts & Consumer Services |            36342.86 |          7290.829 |              29000 |              50000 |
| Social Science                      |            37344.44 |          4750.556 |              32000 |              47000 |
| Business                            |            43538.46 |          7774.053 |              33000 |              62000 |
| Communications & Journalism         |            34500.00 |          1000.000 |              33000 |              35000 |
| Computers & Mathematics             |            42745.45 |          5108.691 |              35000 |              53000 |
| Interdisciplinary                   |            35000.00 |                NA |              35000 |              35000 |
| Law & Public Policy                 |            42200.00 |          9066.422 |              35000 |              54000 |
| Physical Sciences                   |            41890.00 |          8251.660 |              35000 |              62000 |
| Engineering                         |            57382.76 |         13626.080 |              40000 |             110000 |
...
**Response**: I feel like the data will be clustered around the center,
but there will be a large skew to the right.
...
**Response**: It makes it look professional.
...
``` r
college_recent_grads %>% 
  ggplot(mapping  = aes(x= major_category, y = median))+
  geom_boxplot() + geom_jitter(mapping = aes(color = major_category))
```
